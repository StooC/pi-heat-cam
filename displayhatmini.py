# File copied from https://github.com/pimoroni/displayhatmini-python/blob/main/library/displayhatmini/__main__.py
# As this allows it to reference the RPi.GPIO_Def package so no errors in PyCharm
# All credit to Pimoroni!
